...
+"    float spike = tensionIn/3.0*max(pow(sin(sin(posIn.x)*distance*tensionIn/6.0 + 0.15*cos(posIn.z*0.5)), 20.0*(7.0-tensionIn)), 0.0);"
...
+"    colour = colsIn[ int(b)%4 ] * 0.7 + vec3(spike, spike, spike) * 0.3;"
+"  }";
